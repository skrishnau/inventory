...
{
    public partial class ProductLedgerPrintForm : Form
    {
        private readonly IAppSettingService _settingService;
        private ProductLedgerMasterModel _ledgerMasterModel;

        public ProductLedgerPrintForm(IAppSettingService appSettingService, ProductLedgerMasterModel ledgerMasterModel)
        {
        ...
        private void LedgerPrintForm_Load(object sender, EventArgs e)
        {
            ...
            // datasource
            ReportDataSource reportDataSource = new ReportDataSource("LedgerDataset", _ledgerMasterModel.ProductLedgerData);
            this.reportViewer1.LocalReport.DataSources.Add(reportDataSource);

            this.reportViewer1.RefreshReport();
        }

        public IEnumerable<ReportParameter> GetReportParametersForSaleTransaction(ProductLedgerMasterModel model)
        {
